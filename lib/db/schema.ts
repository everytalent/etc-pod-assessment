...
export const tenantAssessmentBranding = pgTable("tenant_assessment_branding", {
  ...
  primaryTextColor: text("primary_text_color").notNull().default("#020301"),
  logoUrl: text("logo_url"),
  textMark: text("text_mark"),
  supportEmail: text("support_email"),
  companyUrl: text("company_url"),
  footerText: text("footer_text"),
  contactEmail: text("contact_email"),
  contactPhone: text("contact_phone"),
  showPoweredByEtc: boolean("show_powered_by_etc").notNull().default(true),
